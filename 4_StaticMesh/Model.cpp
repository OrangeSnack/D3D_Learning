...
bool Model::LoadFile(std::wstring _filePath)
{
	// 파일경로 저장
...
bool Model::LoadVertex(std::vector<Vertex>* _vertices, const aiMesh* _mesh)
{
...
bool Model::LoadIndex(std::vector<UINT>* _indices, const aiMesh* _mesh)
{
...
bool Model::LoadMaterials(std::vector<Materials>& _out, const Model* _model)
{
...
bool Model::Draw(ID3D11DeviceContext* _deviceContext, ID3D11PixelShader* _shader, bool _useMat)
{
	if(_shader)
